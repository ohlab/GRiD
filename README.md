...
2. < multiplex > - for the high-throughput growth analysis of all identified bacteria in a sample. Prior knowledge of microbial composition is not required. To use this module, you must either download the GRiD database or create your custom GRiD database.
...
-  If possible, use the smaller `environ_specific_database` GRiD database or create a custom GRiD database.
...
# Creating and/or updating a GRiD database 
You can create a custom database or update an existing one using metagenomic bins or newly sequenced bacterial genomes.
